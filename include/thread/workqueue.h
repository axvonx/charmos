...
enum workqueue_error cc_warn_unused_result
...
enum workqueue_error cc_warn_unused_result workqueue_add(struct work *work);
...
enum workqueue_error cc_warn_unused_result
workqueue_add_fast(struct work *work);
