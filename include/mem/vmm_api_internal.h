...
#define vmm_map_page_user_4(pml4, v, p, f)                                     \
    vmm_map_page_user_full((pml4), (v), (p), (f), VMM_FLAG_NONE,               \
                           VMM_MAP_PAGE_SIZE_4KB)
#define vmm_map_page_user_5(pml4, v, p, f, vf)                                 \
    vmm_map_page_user_full((pml4), (v), (p), (f), (vf), VMM_MAP_PAGE_SIZE_4KB)
...
#define vmm_get_phys_1(v) vmm_get_phys_full((v), VMM_FLAG_NONE)
...
#define vmm_get_leaf_pte_1(v) vmm_get_leaf_pte_full((v), VMM_FLAG_NONE)
...
#define vmm_map_bump_3(a, l, f) vmm_map_bump_full((a), (l), (f), VMM_FLAG_NONE)
...
#define vmm_mark_demand_page_2(v, f)                                           \
    vmm_mark_demand_page_full((v), (f), VMM_MAP_PAGE_SIZE_4KB)
...
#define vmm_mark_demand_page_user_3(pml4, v, f)                                \
    vmm_mark_demand_page_user_full((pml4), (v), (f), VMM_MAP_PAGE_SIZE_4KB)
...
#define vmm_map_demand_page_3(v, p, f)                                         \
    vmm_map_demand_page_full((v), (p), (f), VMM_MAP_PAGE_SIZE_4KB)
